...
(function ($) {
  $(document).ready(function () {
    ...
    //pongo otro por que usar el mismo no aparece
    boSmallStatsDatasets.map(function (el, index) {
      var chartOptions = boSmallStatsOptions(Math.max.apply(Math, el.data) + 1);
      var ctx = document.getElementsByClassName('blog-overview-stats-small-two-' + (index + 1));
      new Chart(ctx, {
        type: 'line',
        data: {
          labels: ["Label 1", "Label 2", "Label 3", "Label 4", "Label 5", "Label 6", "Label 7"],
    ...
    //     label: 'Current Month',
    //     fill: 'start',
    //     data: [10, 800, 320, 180, 240, 320, 230, 650, 590, 1200, 750, 940, 1420, 1200, 960, 1450, 1820, 2800, 2102, 1920, 3920, 3202, 3140, 2800, 3200, 3200, 3400, 2910, 3100, 4250],
    ...
    //     ]
    //   }],
    //   labels: ["Pedidos", "Ventas", "Entregas"]
    // };

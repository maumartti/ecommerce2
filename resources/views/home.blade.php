      ...
      @if (isset($products))
        @if ($products)
          @foreach ($products as $product)
            ...
            <div class="col-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$product->category_id}} @if($product->promo == 1) populares @endif @if($product->new == 1) new @endif" data-id="{{$product->id}}" data-price="{{$product->price}}" data-sales="{{$product->sales}}">
                <!-- Block2 -->
                <div class="block2">
